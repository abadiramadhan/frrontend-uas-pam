...
import 'package:uas_pam/detailcatatankeluar.dart';


class CatatanKeluar extends StatefulWidget {
  @override
  _CatatanKeluarState createState() => new _CatatanKeluarState();
}

class _CatatanKeluarState extends State<CatatanKeluar> {
          ...
          child: new GestureDetector(
            onTap: () => Navigator.of(context).push(new MaterialPageRoute(
                builder: (BuildContext context) =>
                    new DetailCatatanKeluar(list: list, index: i))),
            child: new Card(
              child: new ListTile(
